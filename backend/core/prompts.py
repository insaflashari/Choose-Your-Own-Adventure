#prompts.py
#Purpose: Tells GPT exactly how to format the story.

#{format_instructions} will be replaced with Pydantic’s required JSON schema.
#Example of what the story JSON should look like.
